...
// ── syntax ────────────────────────────────────────────────────────────────────
for (const f of ['frontmatter-reader.cjs', 'lifecycle-common.mjs', 'memory-root.cjs', 'precompact-flush.mjs', 'capsule-content-gate.mjs']) {
...
// ── fail class: fail-soft DEFAULT vs opt-in strict block ─────────────────────
{
  ...
  for (const f of ['precompact-flush.mjs', 'lifecycle-common.mjs', 'memory-root.cjs', 'frontmatter-reader.cjs', 'capsule-content-gate.mjs']) {
